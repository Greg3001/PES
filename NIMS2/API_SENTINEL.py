...
with open('/Users/grigoryfilimonov/Desktop/NIMS2/result.json', 'w') as f:
    json.dump(result, f, indent=4)


with open('/Users/grigoryfilimonov/Desktop/NIMS2/result.json', 'r') as f:
    data = json.load(f)


with open('/Users/grigoryfilimonov/Desktop/NIMS2/result.csv', 'w', newline='') as csvfile:
